...
const unknownErrorMessage =
    "unknown error! some unexpected error has happend please try again later";
...
const weakPasswordErrorMessage =
    "Weak password! Your password must atleast be 6 charachters long and must have a letter and a number";
